package com.dsce.wmgmt.config.database.pgsql;

import com.dsce.wmgmt.properties.DbProperties;
...
@EnableJpaRepositories(
        basePackages = "com.dsce.wmgmt.repository",
...
public class PgSqlDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerPgSql() {
        ...
        em.setPackagesToScan("com.dsce.wmgmt.entity");
